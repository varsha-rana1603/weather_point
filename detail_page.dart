...
import 'package:weather_point/ui/welcome.dart';
  ...
  Widget build(BuildContext context){
      ...
      Positioned(
        ...
        child: SizedBox(
         ...
         itemBuilder: (BuildContext context, int index){
           ...
           var parsedDate = DateTime.parse(widget.consolidatedWeatherList[index]['applicable_date']);
    ...
    color: Colors.blue.withOpacity(.3),
                  ...
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                   children: [
                      Text(
                        widget.consolidatedWeatherList[index]['the_temp'].round().toString() +
                         "C",
                   style: TextStyle(
                   fontSize: 17,
                   color: index == selectedIndex
    ...
    weatherItem(
        ...
        weatherItem(
      text: 'Max Temp',
      value: widget.consolidatedWeatherList[selectedIndex]
    ['max_temp']
    .round(),
    unit: 'C',
    ...
    (BuildContext context, int index) {
      var futureWeatherName = widget.consolidatedWeatherList[index]
    ['weather_state_name'];
      var futureImageURL = futureWeatherName.replaceAll(' ', '').toLowerCase();
      var myDate = DateTime.parse(widget.consolidatedWeatherList[index]
    ['applicable_date']);
      var currentDate = 
    ...
    Text(widget.consolidatedWeatherList[index]['min_temp'].round().toString(),
    style: const TextStyle(
    color: Colors.grey,
    fontSize: 25,
    ),
    ...
    children: [
      Image.asset('${'assets/' + futureImageURL}.png',
    width: 30),
